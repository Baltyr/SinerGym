...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="canvas-menu mobile-menu">
            <ul>
                <li><a href="./class-timetable.html">Horario de clases</a></li>
        ...
        <div class="canvas-social">
            ...
            <a href="./php/cerrar_sesion.php"><i class="fa-solid fa-right-from-bracket"></i></a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gt-text">
                        ...
                        <p>Almagro 365<br /> los angeles, chile </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="gt-text">
                        ...
                        <ul>
                            <li>+56 9 7778 6707</li>
                            <li>+56 9 3531 6707</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="fs-widget">
                        ...
                        <div class="fw-recent">
                            <h6><a href="#">El ejercicio físico puede ayudar a prevenir la depresión y la ansiedad</a>
                            </h6>
                            <ul>
                                <li>3 min read</li>
                                <li>20 Comment</li>
                        ...
                        <div class="fw-recent">
                            <h6><a href="#">Fitness: El mejor ejercicio para perder grasa abdominal y tonificar...</a>
                            </h6>
                            <ul>
                                <li>3 minutos de lectura</li>
                                <li>20 comentario</li>
                            </ul>
                        </div>
                    </div>
